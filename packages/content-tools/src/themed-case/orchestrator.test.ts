...
describe('orchestrateThemedCase', () => {
  ...
  it('rejects after the initial critique and two unsuccessful repair cycles', async () => {
    ...
    expect(stages.critiqueCase).toHaveBeenCalledTimes(3);
    expect(stages.repairCaseDraft).toHaveBeenCalledTimes(2);
  });
