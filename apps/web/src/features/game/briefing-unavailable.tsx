    ...
    <main className="min-h-screen bg-background px-4 py-5 text-paper sm:px-6 sm:py-8">
      <section className="mx-auto max-w-2xl border border-rule bg-ink/45 p-6 shadow-[6px_6px_0_oklch(0.18_0.024_224_/_0.5)] sm:p-8">
        <p className="text-[0.68rem] font-bold tracking-[0.24em] text-brass uppercase">
          Field intelligence / archive request
        </p>
        ...
        <p className="mt-5 max-w-xl text-base leading-relaxed text-cyan">
          ...
          Review the archive or return to today’s briefing.
        </p>
        <div className="mt-7 flex flex-wrap gap-3">
          <button
            className="inline-flex min-h-11 items-center gap-2 border border-rule bg-ink/40 px-4 text-xs font-bold tracking-[0.12em] text-cyan uppercase hover:border-brass hover:text-paper focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass focus-visible:ring-offset-2 focus-visible:ring-offset-background"
